...
2. **Set up** your environment:
   ...
   \\\`n3. **Configure**: Copy \.env.example\ to \.env\ and fill in your test credentials.
...
- **Commits**: We prefer [Conventional Commits](https://www.conventionalcommits.org/) (e.g., \eat: new command\, \ix: crash on startup\).
